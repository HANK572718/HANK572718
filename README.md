...
**現況**　自動化系統整合商 · 軟體工程師（AI 視覺）｜2024.03 – 2026.06｜逢甲大學 自動控制工程 學士｜方向：視覺演算法 · AI 應用 · 自動化整合

自動控制本科，在自動化系統整合商擔任軟體工程師（AI 視覺，2024.03–2026.06）。做的是把 AI 檢測裝進既有產線的完整流程：相機與光源選型、影像擷取策略、特徵分析與模型選型、推論加速、服務化常駐與現場維運。設備端自己接 —— 相機觸發、光源、時序同步。
...
**硬體整合**　工業相機 · 雷射位移感測 · NVIDIA GPU / Jetson Nano · Intel Arc GPU / Core Ultra NPU · 工業電腦 · PoE
